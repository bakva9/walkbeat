...
Location data is used solely to generate music from your walking route. The app converts GPS coordinates into musical notes — that is the only purpose.
...
| Permission | Why |
|---|---|
| Location (Fine/Coarse) | Record GPS coordinates during walks |
| Background Location | Continue GPS recording when the screen is off |
| Internet | Load map tiles from OpenStreetMap |

## Data deletion

All walk data is stored in localStorage. You can delete it at any time by:
